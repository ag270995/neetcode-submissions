class Solution {
    //this problem is tricky because of it explanation
    //but we just have to find a largest substring such that 
    ...
    //satisfies the condition -> {<length of substring> - <max Frequency of present substring>} because we don't want to replace the most frequent character because they contribute the most to same letter substring
    //i.e -> (r - l + 1) - maxFrequency <= k
    // if thats not the case then in order to reduce (r - l + 1)
