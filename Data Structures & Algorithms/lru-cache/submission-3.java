//LRU cache is basically a data structure having map for constant key look up
//while we need doubly linked list to evict the least recently used entry
//and putting new and existing elemtent to front to maintain their relevency
class LRUCache {
