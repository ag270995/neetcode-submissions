...
// When a smaller bar comes, the current smaller bar becomes the right boundary (smallest right - 1) => i - 1
// for the bars that are popped, and the element remaining at the top of the stack
// becomes the left boundary (means smallest left + 1) -> stack.peek() + 1
//
